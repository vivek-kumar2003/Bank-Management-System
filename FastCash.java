...
public class FastCash extends JFrame implements ActionListener{
    ...
    FastCash(String pinnumber){
        ...
        withdrawl.setBackground(Color.MAGENTA);
        ...
        fastcash.setBackground(Color.MAGENTA);
        ...
        ministatement.setBackground(Color.MAGENTA);
        ...
        pinchange.setBackground(Color.MAGENTA);
        ...
        balanceenquiry.setBackground(Color.MAGENTA);
